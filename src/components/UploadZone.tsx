    ...
    >
      ...
      <div className="mt-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row">
        <button
          ...
          className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-amber-400 to-red-500 px-6 py-3 font-display text-sm font-bold text-white shadow-lg shadow-red-500/30 transition hover:scale-105 hover:shadow-xl sm:text-base"
        >
          📁 Загрузить файл
        </button>
        <button
          onClick={() => cameraRef.current?.click()}
          className="rounded-xl bg-white/10 px-6 py-3 font-display text-sm font-bold text-white ring-1 ring-white/20 backdrop-blur transition hover:scale-105 hover:bg-white/20 sm:text-base"
        >
          📸 Сфоткать кота
        </button>
      </div>
